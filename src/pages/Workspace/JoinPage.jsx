...
export const JoinPage = () => {
 ...
 // intregate the api in which enter the join code 
 // if the joincode is true then trigger the the api addMemberToWorkspace
 // 


 // Now implement the feature that while clicking on channel 
 // url should be different but the Home don't change
 // and show some information on the workspace page